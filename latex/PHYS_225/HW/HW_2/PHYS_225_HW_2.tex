...
\begin{itemize}
    ...
    \item[c)] \(\displaystyle\gamma = \left(\sqrt{1-\frac{v^2}{c^2}}\right)^{-1}=\left(\sqrt{1-0.9999^2}\right)^{-1}=70.7124\) %2x10^{-4}
    \begin{itemize}
...
\begin{itemize}
    ...
    \item [c)] \(\gamma = \frac{1}{\sqrt{1-\frac{1}{9}}}\)
    \(t' = t\times \frac{1}{\gamma}=\fbox{\(\frac{\sqrt{8}L}{c}\)}\)
\end{itemize}
